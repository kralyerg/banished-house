...
{
	SpriteSheet _spriteSheet = "Dialog/TwoSpriteSheet.rsc";
	String _spriteName = "BuildTwoStoryHouse";

	StringTable _stringTable = "Dialog/TwoStringTable.rsc:objects";
	String _stringName = "TwoStoryHouse";
	String _stringNameLwr = "TwoStoryHouseLwr";
	String _toolTip = "TwoStoryHouseTip";
